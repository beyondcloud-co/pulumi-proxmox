...
import (
	...
	"github.com/beyondcloud-co/pulumi-proxmox/provider/pkg/version"
...
const (
	...
	mainPkg = "proxmox"
	// modules:
	mainMod = "index" // the proxmox module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources:            map[string]*tfbridge.ResourceInfo{
			...
			// 	},
			// },
			"proxmox_vm_qemu": {Tok: tfbridge.makeResource(mainMod, "QemuVM")},
			"proxmox_pool": {Tok: tfbridge.makeResource(mainMod, "Pool")},
			"proxmox_lxc": {Tok: tfbridge.makeResource(mainMod, "LXCContainer")},
			"proxmox_lxc_disk": {
				Tok:                 tfbridge.makeResource(mainMod, "LXCDisk"),
