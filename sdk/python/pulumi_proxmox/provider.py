...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 pm_debug: Optional[pulumi.Input[bool]] = None,
                 ...
                 pm_proxy_server: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] pm_debug: Enable or disable the verbose debug output from proxmox api
        ...
        :param pulumi.Input[str] pm_proxy_server: Proxy Server passed to Api client(useful for debugging). Syntax: http://proxy:port
        :param pulumi.Input[int] pm_timeout: How much second to wait for operations for both provider and api-client, default is 300s
        ...
        if pm_debug is not None:
            pulumi.set(__self__, "pm_debug", pm_debug)
        ...
        if pm_proxy_server is not None:
            pulumi.set(__self__, "pm_proxy_server", pm_proxy_server)
    ...
    @property
    @pulumi.getter(name="pmDebug")
    def pm_debug(self) -> Optional[pulumi.Input[bool]]:
        """
        Enable or disable the verbose debug output from proxmox api
        """
        return pulumi.get(self, "pm_debug")

    @pm_debug.setter
    def pm_debug(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "pm_debug", value)
    ...
    @property
    @pulumi.getter(name="pmProxyServer")
    def pm_proxy_server(self) -> Optional[pulumi.Input[str]]:
        """
        Proxy Server passed to Api client(useful for debugging). Syntax: http://proxy:port
        """
        return pulumi.get(self, "pm_proxy_server")

    @pm_proxy_server.setter
    def pm_proxy_server(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "pm_proxy_server", value)
...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["pm_debug"] = pulumi.Output.from_input(pm_debug).apply(pulumi.runtime.to_json) if pm_debug is not None else None
            ...
            __props__.__dict__["pm_proxy_server"] = pm_proxy_server
    ...
    @property
    @pulumi.getter(name="pmProxyServer")
    def pm_proxy_server(self) -> pulumi.Output[Optional[str]]:
        """
        Proxy Server passed to Api client(useful for debugging). Syntax: http://proxy:port
        """
        return pulumi.get(self, "pm_proxy_server")
