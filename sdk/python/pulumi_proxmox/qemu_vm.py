...
class QemuVMArgs:
    def __init__(__self__, *,
                 ...
                 automatic_reboot: Optional[pulumi.Input[bool]] = None,
                 ...
                 oncreate: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] target_node: The node where VM goes to
        :param pulumi.Input[bool] automatic_reboot: Automatically reboot the VM if any of the modified parameters require a reboot to take effect.
        :param pulumi.Input[str] bios: The VM bios, it can be seabios or ovmf
        :param pulumi.Input[str] boot: Boot order of the VM
        :param pulumi.Input[str] desc: The VM description
        :param pulumi.Input[str] name: The VM name
        :param pulumi.Input[bool] onboot: VM autostart on boot
        :param pulumi.Input[bool] oncreate: VM autostart on create
        :param pulumi.Input[str] ssh_forward_ip: Use to pass instance ip address, redundant
        :param pulumi.Input[bool] tablet: Enable tablet mode in the VM
        :param pulumi.Input[int] vmid: The VM identifier in proxmox (100-999999999)
        """
        pulumi.set(__self__, "target_node", target_node)
        if additional_wait is not None:
            warnings.warn("""do not use anymore""", DeprecationWarning)
            pulumi.log.warn("""additional_wait is deprecated: do not use anymore""")
        if additional_wait is not None:
        ...
        if automatic_reboot is not None:
            pulumi.set(__self__, "automatic_reboot", automatic_reboot)
        ...
        if clone_wait is not None:
            warnings.warn("""do not use anymore""", DeprecationWarning)
            pulumi.log.warn("""clone_wait is deprecated: do not use anymore""")
        if clone_wait is not None:
        ...
        if guest_agent_ready_timeout is not None:
            warnings.warn("""Use custom per-resource timeout instead. See https://www.terraform.io/docs/language/resources/syntax.html#operation-timeouts""", DeprecationWarning)
            pulumi.log.warn("""guest_agent_ready_timeout is deprecated: Use custom per-resource timeout instead. See https://www.terraform.io/docs/language/resources/syntax.html#operation-timeouts""")
        if guest_agent_ready_timeout is not None:
        ...
        if oncreate is not None:
            pulumi.set(__self__, "oncreate", oncreate)
        ...
        if preprovision is not None:
            warnings.warn("""do not use anymore""", DeprecationWarning)
            pulumi.log.warn("""preprovision is deprecated: do not use anymore""")
        if preprovision is not None:
    ...
    @property
    @pulumi.getter(name="automaticReboot")
    def automatic_reboot(self) -> Optional[pulumi.Input[bool]]:
        """
        Automatically reboot the VM if any of the modified parameters require a reboot to take effect.
        """
        return pulumi.get(self, "automatic_reboot")

    @automatic_reboot.setter
    def automatic_reboot(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "automatic_reboot", value)
    ...
    @property
    @pulumi.getter
    def oncreate(self) -> Optional[pulumi.Input[bool]]:
        """
        VM autostart on create
        """
        return pulumi.get(self, "oncreate")

    @oncreate.setter
    def oncreate(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "oncreate", value)
...
class _QemuVMState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bios: The VM bios, it can be seabios or ovmf
        :param pulumi.Input[str] boot: Boot order of the VM
        :param pulumi.Input[str] default_ipv4_address: Use to track vm ipv4 address
        :param pulumi.Input[str] desc: The VM description
        :param pulumi.Input[str] name: The VM name
        :param pulumi.Input[bool] onboot: VM autostart on boot
        :param pulumi.Input[bool] oncreate: VM autostart on create
...
class QemuVM(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if additional_wait is not None and not opts.urn:
                warnings.warn("""do not use anymore""", DeprecationWarning)
                pulumi.log.warn("""additional_wait is deprecated: do not use anymore""")
            __props__.__dict__["additional_wait"] = additional_wait
            __props__.__dict__["agent"] = agent
            __props__.__dict__["args"] = args
            __props__.__dict__["automatic_reboot"] = automatic_reboot
            ...
            if clone_wait is not None and not opts.urn:
                warnings.warn("""do not use anymore""", DeprecationWarning)
                pulumi.log.warn("""clone_wait is deprecated: do not use anymore""")
            ...
            if guest_agent_ready_timeout is not None and not opts.urn:
                warnings.warn("""Use custom per-resource timeout instead. See https://www.terraform.io/docs/language/resources/syntax.html#operation-timeouts""", DeprecationWarning)
                pulumi.log.warn("""guest_agent_ready_timeout is deprecated: Use custom per-resource timeout instead. See https://www.terraform.io/docs/language/resources/syntax.html#operation-timeouts""")
            ...
            __props__.__dict__["ipconfig3"] = ipconfig3
            __props__.__dict__["ipconfig4"] = ipconfig4
            __props__.__dict__["ipconfig5"] = ipconfig5
    ...
    @property
    @pulumi.getter(name="automaticReboot")
    def automatic_reboot(self) -> pulumi.Output[Optional[bool]]:
        """
        Automatically reboot the VM if any of the modified parameters require a reboot to take effect.
        """
        return pulumi.get(self, "automatic_reboot")
    ...
    @property
    @pulumi.getter
    def ipconfig3(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "ipconfig3")

    @property
    @pulumi.getter
    def ipconfig4(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "ipconfig4")

    @property
    @pulumi.getter
    def ipconfig5(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "ipconfig5")
    ...
    @property
    @pulumi.getter
    def oncreate(self) -> pulumi.Output[Optional[bool]]:
        """
        VM autostart on create
        """
        return pulumi.get(self, "oncreate")
    ...
    @property
    @pulumi.getter
    def tablet(self) -> pulumi.Output[Optional[bool]]:
        """
        Enable tablet mode in the VM
        """
        return pulumi.get(self, "tablet")
