...
export class QemuVM extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: QemuVMArgs | QemuVMState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["ipconfig3"] = state ? state.ipconfig3 : undefined;
            inputs["ipconfig4"] = state ? state.ipconfig4 : undefined;
            inputs["ipconfig5"] = state ? state.ipconfig5 : undefined;
            ...
            inputs["ipconfig3"] = args ? args.ipconfig3 : undefined;
            inputs["ipconfig4"] = args ? args.ipconfig4 : undefined;
            inputs["ipconfig5"] = args ? args.ipconfig5 : undefined;
