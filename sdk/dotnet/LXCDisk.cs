...
namespace Pulumi.Proxmox
{
    ...
    public partial class LXCDisk : Pulumi.CustomResource
    {
        ...
        public LXCDisk(string name, LXCDiskArgs args, CustomResourceOptions? options = null)
            : base("proxmox:index/lXCDisk:LXCDisk", name, args ?? new LXCDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LXCDisk(string name, Input<string> id, LXCDiskState? state = null, CustomResourceOptions? options = null)
            : base("proxmox:index/lXCDisk:LXCDisk", name, state, MakeResourceOptions(options, id))
        {
        }
